...
func resourceComputeGlobalForwardingRuleRead(resource map[string]interface{}, config *transport_tpg.Config) (map[string]interface{}, error) {
	...
	result["service_directory_registrations"] = flattenComputeGlobalForwardingRuleServiceDirectoryRegistrations(resource["serviceDirectoryRegistrations"], resource_data, config)
